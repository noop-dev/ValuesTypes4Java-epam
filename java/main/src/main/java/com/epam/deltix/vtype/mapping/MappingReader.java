...
import com.epam.deltix.vtype.transformer.Warnings;
...
import static com.epam.deltix.vtype.transformer.AsmUtil.classNameToPath;
import static com.epam.deltix.vtype.transformer.AsmUtil.makeTypeDesc;
...
public class MappingReader {
    ...
    private ClassDef parseClass(final JSONObject json, int classIndex, final Mapping m) throws IOException {
        ...
        cl.setFlag(ClassDefFlags.F_SRC_BOX_METHOD_DEFINED | ClassDefFlags.F_DST_BOX_METHOD_DEFINED
                | ClassDefFlags.F_SRC_UNBOX_METHOD_DEFINED | ClassDefFlags.F_DST_UNBOX_METHOD_DEFINED);
        ...
        if (null != methods) {
            ...
            cl.setFlag(ClassDefFlags.F_SRC_ALL_METHODS_DEFINED | ClassDefFlags.F_DST_ALL_METHODS_DEFINED);
        }
