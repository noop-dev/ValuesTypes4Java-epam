...
public class ClassDef {
    ...
    public void setAllSrcMethodsScanned() {
        setFlag(ClassDefFlags.F_SRC_ALL_METHODS_DEFINED);
    }

    public void setAllDstMethodsScanned() {
        setFlag(ClassDefFlags.F_DST_ALL_METHODS_DEFINED);
    }
    ...
    public ClassDef setFlag(int flag) {
        ...
        assert (0 == (flags & ~ClassDefFlags.F_ALL_MAPPING_FLAGS));
        flags |= flag;
        return this;
    }
    ...
    public void mapClassMethods() {
        ...
        if (!ClassDefFlags.allSet(flags, ClassDefFlags.F_SRC_BOX_METHOD_DEFINED | ClassDefFlags.F_SRC_UNBOX_METHOD_DEFINED |
                ClassDefFlags.F_DST_BOX_METHOD_DEFINED | ClassDefFlags.F_DST_UNBOX_METHOD_DEFINED | ClassDefFlags.F_SRC_ALL_METHODS_DEFINED | ClassDefFlags.F_SRC_CLASS_PROCESSED)) {
        ...
        flags |= ClassDefFlags.F_DST_ALL_METHODS_DEFINED;
        if (!allMethodsMapped())
    ...
    public void loadNullValue() throws ClassNotFoundException, InvocationTargetException, IllegalAccessException {
        ...
        flags |= ClassDefFlags.F_NULL_CONSTANT_DEFINED;
    }
