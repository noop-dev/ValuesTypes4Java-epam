...
import com.epam.deltix.vtype.interpreter.InstructionIterator;
import com.epam.deltix.vtype.mapping.ClassDef;
import com.epam.deltix.vtype.mapping.Mapping;
import com.epam.deltix.vtype.type.FrameMap;
import com.epam.deltix.vtype.type.JvmStack;
...
// = new VariableMapV2(varFormatter);
    ...
    void onNewMethod(MethodNode methodNode) {
        ...
        stack.resetStack();
        frameMap.clear();
        AsmUtil.initializeMethodArguments(variableMap, methodNode, mapping);
